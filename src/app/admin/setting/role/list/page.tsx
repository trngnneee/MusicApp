        ...
        <table className="bg-white w-full">
          <thead className="">
            <tr className="bg-[#FCFDFD]">
              ...
              <th className="px-[32px] py-[15px] text-left align-middle">Tên nhóm quyền</th>
              <th className="px-[32px] py-[15px] text-left align-middle">Mô tả ngắn</th>
          ...
          <tbody>
            <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
              ...
              <th className="px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Quản trị viên</th>
              <th className="px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Có đầy đủ tất cả các quyền</th>
              <th className="px-[32px] py-[8px] text-left align-middle">
