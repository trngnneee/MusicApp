        ...
        <table className="bg-white w-full">
          <thead className="">
            <tr className="bg-[#FCFDFD]">
              ...
              <th className="px-[32px] py-[15px] text-left align-middle">Tên ca sĩ</th>
          ...
          <tbody>
            <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
              ...
              <th className="px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Ca sĩ 1</th>
              <th className="px-[32px] py-[8px] text-left align-middle">
            ...
            <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
              ...
              <th className="px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Ca sĩ 2</th>
              <th className="px-[32px] py-[8px] text-left align-middle">
                <div className="w-[60px] h-[60px] overflow-hidden">
                  <img src="/demoAvatar.png" className="w-full h-full object-cover" />
                </div>
