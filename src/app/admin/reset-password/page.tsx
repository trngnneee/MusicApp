        ...
        <div className="bg-white w-[630px] py-[90px] px-[57px] rounded-[24px] mx-auto">
          ...
          <form className="mb-[30px]">
            <div className="flex flex-col mb-[30px]">
              <label className="font-[600] text-[18px] text-dark mb-[15px]" htmlFor="reset-password">Mật khẩu mới</label>
              <input
                type="password"
                id="reset-password"
            ...
            <div className="flex flex-col mb-[30px]">
              <label className="font-[600] text-[18px] text-dark mb-[15px]" htmlFor="reset-password">Xác nhận mật khẩu</label>
              <input
                type="password"
                id="reset-password"
                className="bg-[#F1F4F9] w-full p-[16px] rounded-[8px] outline-none border-[1px] border-[#D8D8D8] text-[18px] font-[600] text-[#A6A6A6]"
