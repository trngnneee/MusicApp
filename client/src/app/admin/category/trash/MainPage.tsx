...
export const MainPage = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/admin/category/trash/list${query}`, {
      credentials: "include"
    })
      .then(res => res.json())
      .then(data => {
  ...
  const handleRecover = (id: string) => {
    ...
    const promise = fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/admin/category/trash/recovery`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const handleDelete = (id: string) => {
    ...
    const promise = fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/admin/category/trash/hard-delete`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
            ...
            <table className="bg-white w-full min-w-[1000px]">
              <thead className="">
                <tr className="bg-[#FCFDFD]">
                  ...
                  <th className="px-[15px] xl:px-[25px] py-[15px] text-left align-middle">Tên danh mục</th>
