            ...
            <table className="bg-white w-full min-w-[1000px]">
              <thead className="">
                <tr className="bg-[#FCFDFD]">
                  <th className="px-[15px] py-[15px] text-left align-middle">
                    <input type="checkbox" className="translate-y-[2px]" />
                  </th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Họ tên</th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Ảnh đại diện</th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Email</th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Số điện thoại</th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Nhóm quyền</th>
                  <th className="px-[15px] py-[15px] text-left align-middle">Chức vụ</th>
              ...
              <tbody>
                <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
                  ...
                  <th className="px-[15px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Lê Văn A</th>
                  <th className="px-[15px] py-[8px] text-left align-middle">
                    <div className="w-[60px] h-[60px] overflow-hidden">
                      <img src="/demoAvatar.png" className="w-full h-full object-cover" />
                    </div>
                  </th>
                  <th className="px-[15px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">levana@gmail.com</th>
                  <th className="px-[15px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">0123456789</th>
                  <th className="px-[15px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Quản trị viên</th>
                  <th className="px-[15px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Giám đốc</th>
                  <th className="px-[15px] py-[8px] text-left align-middle">
                    <Active />
                  </th>
                  <th className="px-[15px] py-[8px] text-left align-middle">
