...
import { SongFilter } from "@/app/admin/song/list/SongFilter";
        ...
        <table className="bg-white w-full min-w-[1000px]">
          ...
          <tbody>
            <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
              ...
              <th className="px-[15px] xl:px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Bài hát 1</th>
              <th className="px-[15px] xl:px-[32px] py-[8px] text-left align-middle">
            ...
            <tr className="bg-white border-t-[#D5D5D5] border-t-[0.6px]">
              ...
              <th className="px-[15px] xl:px-[32px] py-[8px] text-left align-middle font-[600] text-[14px] text-dark">Bài hát 2</th>
              <th className="px-[15px] xl:px-[32px] py-[8px] text-left align-middle">
                <div className="w-[60px] h-[60px] overflow-hidden">
                  <img src="/demoAvatar.png" className="w-full h-full object-cover" />
                </div>
