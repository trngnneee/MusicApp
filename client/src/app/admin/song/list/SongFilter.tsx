...
export const SongFilter = (props: {
  ...
  const { status, setStatus, createdBy, setCreatedBy, startDate, setStartDate, endDate, setEndDate, category, setCategory, adminAccountList, categoryTree, handleClearFilter } = props;
